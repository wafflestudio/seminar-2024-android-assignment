...
class SearchViewModel : ViewModel() {
    ...
    private fun parseGenreUserList(jsonString: String): List<Genre> {
        return Json.decodeFromString(jsonString)
    }

    private fun loadGenreJsonData() {
...
"""
        val genreList = parseGenreUserList(jsonArrayString)
        _buttonData.value = genreList
    }


    private fun parseMovieUserList(jsonString: String): List<Movie> {
        return Json.decodeFromString(jsonString)
    }

    private fun loadMovieJsonData(){
  ...
  [
    ...
    },
    {
      ...
      "vote_count": 70
        ...
        val movieList = parseMovieUserList(jsonArrayString)
        allMovies.addAll(movieList)
        _movieData.value = allMovies
    }
